<template>
  <section class="relative mx-auto bg-white overflow-hidden font-poppins">
    <div class="relative bg-[url('/asset/index/our-journey-bg-1.png')] bg-cover bg-center bg-no-repeat">
      <div class="absolute inset-0 bg-gradient-to-b from-red-900/20 via-black/50 to-black/70"></div>

      <!-- pakai container yang sama -->
      <div class="relative max-w-screen-2xl mx-auto px-4 py-48">
        <div class="w-12 h-1 bg-red-600 mb-3"></div>

        <p class="text-md tracking-wide text-red-500 font-bold">
          Discover the history of GBJ
        </p>
        <h2 class="text-7xl font-bold text-white mt-2 py-12">
          Turning idea <br />
          into an invention
        </h2>
        <p class="mt-4 text-gray-100 text-2xl">
          Do you know how our first innovation was made?
        </p>
      </div>
    </div>
      ...
      <div class="max-w-full mx-auto overflow-hidden">
        <div class="relative z-10">
          ...
          <div class="overflow-x-auto relative">
            <!-- Background Banner -->
            <div
              class="absolute left-[384px] right-[-48px] top-[192px] h-[160px] bg-[url('/asset/index/2021-history.png')] bg-cover bg-center z-[1]"
            >
            ...
            <div class="flex gap-0 min-h-[600px] w-max">
              <!-- Title Section -->
              <div class="flex-shrink-0 w-96 flex flex-col justify-center bg-white">
                <div class="p-8 text-left">
                  <div class="inline-flex items-center gap-3 mb-6">
                    <div class="w-10 h-10 bg-red-700 rounded-full flex items-center justify-center">
                      <span class="text-white font-bold text-sm">GBJ</span>
                    </div>
                    <span class="text-xl font-bold text-gray-800">PT Global Bestindo Jaya</span>
                  </div>
                  <h1 class="text-sm text-red-600 font-medium mb-2 tracking-wider uppercase">Our History of</h1>
                  <h2 class="text-4xl md:text-5xl font-bold text-gray-800 mb-6">
                    CREATING <span class="text-red-600">INNOVATION</span>
                  </h2>
                  <p class="text-lg text-gray-600 leading-relaxed">
                    Perjalanan PT Global Bestindo Jaya dalam membangun produk berkualitas tinggi
                    untuk kebutuhan industri nasional selama bertahun-tahun.
                  </p>
                </div>
              </div>
              ...
              <div class="flex-shrink-0 relative w-80">
                ...
                <div class="h-40 relative overflow-hidden flex items-start justify-center pt-1 z-10">
              ...
              <div class="flex-shrink-0 relative w-80">
                <div class="h-48 bg-white"></div>
                <div class="h-40 relative overflow-hidden flex items-end justify-center pb-1 z-10">
              ...
              <div class="flex-shrink-0 relative w-80">
                ...
                <div class="h-48 p-6 bg-white">
                  ...
                  <p class="text-gray-600 text-sm leading-relaxed mb-4">
                    Ekspansi pasar ke seluruh wilayah Indonesia untuk memperkuat distribusi nasional.
                  </p>
                </div>
              </div>
              ...
              <div class="flex-shrink-0 relative w-80">
                <div class="h-48 p-6 bg-white">
                  <h3 class="text-gray-800 font-bold text-lg mb-2 tracking-wide text-red-500">LINI PREMIUM</h3>
                  <p class="text-gray-600 text-sm leading-relaxed mb-4">
              ...
              <div class="flex-shrink-0 relative w-80">
                ...
                <div class="h-48 p-6 bg-white">
                  ...
                  <p class="text-gray-600 text-sm leading-relaxed mb-4">
                    Membuka gudang baru di Surabaya untuk mempercepat pengiriman ke Indonesia Timur.
                  </p>
                </div>
              </div>
              ...
              <div class="flex-shrink-0 relative w-80">
                <div class="h-48 p-6 bg-white">
                  <h3 class="text-gray-800 font-bold text-lg mb-2 tracking-wide text-red-500">TEKNOLOGI DIGITAL</h3>
                  <p class="text-gray-600 text-sm leading-relaxed mb-4">
              ...
              <!-- Year 2025 - BOTTOM (dengan arrow merah) -->
              <div class="flex-shrink-0 relative w-80">
                <div class="h-48 bg-white"></div>
                <div class="h-40 relative z-10">
                  <!-- angka -->
                  <div class="h-full relative overflow-hidden flex items-end justify-center pb-1">
                  ...
                  <div class="absolute right-0 top-0 h-full w-12 z-0">
                    <div class="h-full relative [clip-path:polygon(0_0,60%_50%,0_100%)]">
                ...
                <div class="h-48 p-6 bg-white relative">
                  ...
                  <p class="text-gray-600 text-sm leading-relaxed mb-4">
                    Meluncurkan akun Instagram resmi sebagai langkah awal transformasi digital.
                  </p>
          ...
          <div class="flex justify-center mt-8">
            <div class="flex items-center gap-2 text-gray-600 text-sm bg-gray-100 rounded-full px-6 py-3">
