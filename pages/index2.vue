<template>
  ...
  <div class="font-poppins">
    <div class="max-w-screen-2xl mx-auto px-4">
      <!-- Tambahkan tinggi yang jelas di sini -->
      <div class="flex h-screen flex-col justify-center items-start text-left">
        ...
        <div>
          <button
            ...
            class="bg-red-700 hover:bg-red-800 text-white px-20 py-3 rounded-full font-semibold transition duration-300"
          >
            FIND OUT MORE
          </button>
        </div>
  ...
  <!-- Contact Section -->
  <section>
    <div class="bg-red-700 text-white py-16 px-4 sm:px-6 lg:px-8 font-poppins">
      <div class="max-w-screen-xl mx-auto text-center">
        <h2 class="text-3xl md:text-4xl font-bold mb-4">Get in Touch</h2>
        <p class="mb-8">Have questions or need more information? We're here to help!</p>
        <NuxtLink
          to="/contact"
          class="bg-white text-red-700 font-semibold px-8 py-3 rounded-full hover:bg-gray-100 transition duration-300"
        >
          Contact Us
        </NuxtLink>
      </div>
