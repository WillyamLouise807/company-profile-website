    ...
    <div class="max-w-screen-2xl mx-auto px-4 sm:px-6 py-10 mt-10 font-poppins text-black">
      ...
      <div class="flex flex-col-reverse md:grid md:grid-cols-2 gap-10 items-start">
        ...
        <div>
          ...
          <p class="text-gray-700 text-base sm:text-lg mb-6 leading-relaxed">
            Glatino's Cylinder 65155 ET Lock is designed to provide optimal protection.
          </p>

          <div class="mb-6 space-y-1">
            <h2 class="text-lg sm:text-xl font-semibold mb-2">Product Description:</h2>          
            <p class="capitalize text-sm sm:text-base">Thumbturn Cylinder</p>
          ...
          <div class="mb-8">
            ...
            <div class="flex flex-wrap justify-center md:justify-start items-center gap-6">
              <a href="https://www.tokopedia.com/glatino-official-store/glatino-cylinder-pro-kunci-tabung-pengaman-bahan-aluminium-anti-karat-harga-terjangkau-1730966763212211950?extParam=src%3Dshop%26whid%3D18402450&aff_unique_id=&channel=others&chain_key=" target="_blank" rel="noopener noreferrer" class="hover:scale-105 transition-transform">
      ...
      <div class="mt-14 border-t border-gray-700 pt-10">
        ...
        <div class="flex flex-col items-center">
          <img
            :src="ukuranImage"
            alt="Ukuran Cylinder ET65-PUTAR"
...
import hitam from '/asset/product/cylinder/65155-et/hitam.png'
import ukuran from '/asset/product/cylinder/65155-et/ukuran-hitam.png'
