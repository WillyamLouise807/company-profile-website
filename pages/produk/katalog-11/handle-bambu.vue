  ...
  <div class="bg-white">
    <div class="max-w-screen-2xl mx-auto px-4 sm:px-6 py-10 mt-10 font-poppins text-black">
      ...
      <div class="flex flex-col-reverse lg:grid lg:grid-cols-2 gap-10 items-start">
        <!-- Deskripsi -->
        <div>
          <h1 class="text-2xl sm:text-3xl md:text-4xl font-bold mb-4">Flush Handle Bambo</h1>
          <p class="text-gray-700 text-base sm:text-lg mb-6 leading-relaxed">
            Swing Handle Kotak Glatino hadir dengan desain kokoh dan keamanan tinggi. Terbuat dari bahan aluminium atau stainless steel dengan berbagai pilihan finishing, handle ini cocok untuk pintu yang membutuhkan perlindungan ekstra dan tampilan modern.
          </p>
...
import hitam from '/asset/product/flush-handle/handle-bambu/hitam.png'
import cokelat from '/asset/product/flush-handle/handle-bambu/cokelat.png'
import putih from '/asset/product/flush-handle/handle-bambu/putih.png'
import snss from '/asset/product/flush-handle/handle-bambu/silver.png'
import ukuran from '/asset/product/flush-handle/handle-bambu/ukuran-hitam.png'
