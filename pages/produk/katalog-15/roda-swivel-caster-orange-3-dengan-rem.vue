      ...
      <div class="flex flex-col-reverse lg:grid lg:grid-cols-2 gap-10 items-start">
        ...
        <div>
          ...
          <p class="text-gray-700 text-base sm:text-lg mb-6 leading-relaxed">
            High quality PVC wheels for a wide range of industrial and commercial applications, offering optimal durability, traction and performance without a brake system.
          </p>
