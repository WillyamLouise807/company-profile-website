    ...
    <div class="max-w-screen-2xl mx-auto px-4 sm:px-6 py-10 mt-10 font-poppins text-black">
      ...
      <nav class="text-xs text-gray-400 mb-6" aria-label="Breadcrumb">
        <ol class="flex flex-wrap items-center gap-2">
          ...
          <li>/</li>
          <li class="text-black font-semibold">Swivel Caster Orange 3"</li>
        </ol>
      </nav>
      ...
      <div class="flex flex-col-reverse lg:grid lg:grid-cols-2 gap-10 items-start">
        <!-- Deskripsi -->
        <div>
          <h1 class="text-2xl sm:text-3xl md:text-4xl font-bold mb-4">Roda Swivel Caster Orange 3"</h1>
          <p class="text-gray-700 text-base sm:text-lg mb-6 leading-relaxed">
            A 3-inch swivel caster wheel designed to allow easy movement and flexible direction.
          </p>

          <div class="mb-6 space-y-1">
            <h2 class="text-lg sm:text-xl font-semibold mb-2">Product Description:</h2>            
            <p class="capitalize text-sm sm:text-base">Size: 3 Inch</p>
            <p class="capitalize text-sm sm:text-base">Material: PVC</p>
            <p class="capitalize text-sm sm:text-base">Finishing: Black</p>
            <p class="capitalize text-sm sm:text-base">Bearing: Double Ball Bearing</p>
            <p class="capitalize text-sm sm:text-base">Type: Swivel</p>
            <p class="capitalize text-sm sm:text-base">Brake Type: Side Pedal Brake</p>             
          </div>
        ...
        <div class="flex justify-center items-center w-full">
          <img
            src="/asset/product/roller-caster/roda-swivel-caster-orange-2-dengan-rem.png"
            alt="Roda Swivel Caster Orange 3"
            class="rounded-2xl shadow-lg w-full aspect-video object-contain bg-white cursor-zoom-in"
            @click="openZoom('/asset/product/roller-caster/roda-swivel-caster-orange-3-dengan-rem.png')"
          />
        </div>
      </div>
      ...
      <!-- <div class="mt-14 border-t border-gray-700 pt-10">
        ...
        <div class="flex flex-col items-center">
          <img
            src="/asset/product/alumunium-lock/ss-201/ukuran-hitam.png"
      ...
      <div class="border-t border-gray-200 my-20 py-8">
        ...
        <div class="flex justify-center">
          <div class="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-4 xl:grid-cols-7 gap-4">
            <NuxtLink
