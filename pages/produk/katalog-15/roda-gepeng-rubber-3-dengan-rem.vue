    ...
    <div class="max-w-screen-2xl mx-auto px-4 sm:px-6 py-10 mt-10 font-poppins text-black">
      ...
      <nav class="text-xs text-gray-400 mb-6" aria-label="Breadcrumb">
        <ol class="flex flex-wrap items-center gap-2">
          ...
          <li>/</li>
          <li class="text-black font-semibold">Roda Gepeng Rubber 3"</li>
        </ol>
      </nav>
      ...
      <div class="flex flex-col-reverse lg:grid lg:grid-cols-2 gap-10 items-start">
        <!-- Deskripsi -->
        <div>
          <h1 class="text-2xl sm:text-3xl md:text-4xl font-bold mb-4">Roda Gepeng Rubber 3"</h1>
          <p class="text-gray-700 text-base sm:text-lg mb-6 leading-relaxed">
            A 3-inch flat wheel made from rubber material, designed to support movement and smooth rolling.
          </p>

          <div class="mb-6 space-y-1">
            <h2 class="text-lg sm:text-xl font-semibold mb-2">Product Description:</h2>
            <p class="capitalize text-sm sm:text-base">Dimensions: 3 Inch</p>
            <p class="capitalize text-sm sm:text-base">Material: Rubber</p>            
            <p class="capitalize text-sm sm:text-base">Type: With Brake</p>
          </div>
        ...
        <div class="flex justify-center items-center w-full">
          <img
            src="/asset/product/roller-caster/roda-gepeng-rubber-3-dengan-rem.png"
            alt="Roda Gepeng Rubber 3"
            class="rounded-2xl shadow-lg w-full aspect-video object-contain bg-white cursor-zoom-in"
            @click="openZoom('/asset/product/roller-caster/roda-gepeng-rubber-3-dengan-rem.png')"
          />
        </div>
      </div>
