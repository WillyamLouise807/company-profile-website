    ...
    <div class="max-w-screen-2xl mx-auto px-4 sm:px-6 py-10 mt-10 font-poppins text-black">
      ...
      <nav class="text-xs text-gray-400 mb-6" aria-label="Breadcrumb">
        <ol class="flex flex-wrap items-center gap-2">
          ...
          <li>/</li>
          <li class="text-black font-semibold">Roda Gepeng Rubber 3" Tanpa Rem</li>
        </ol>
      </nav>
      ...
      <div class="flex flex-col-reverse lg:grid lg:grid-cols-2 gap-10 items-start">
        <!-- Deskripsi -->
        <div>
          <h1 class="text-2xl sm:text-3xl md:text-4xl font-bold mb-4">Roda Gepeng Rubber 3" Tanpa Rem</h1>
          <p class="text-gray-700 text-base sm:text-lg mb-6 leading-relaxed">
            Roda karet berkualitas tinggi untuk berbagai aplikasi industri dan komersial, menawarkan daya tahan, traksi, dan performa optimal tanpa sistem rem.
          </p>

          <div class="mb-6 space-y-1">
            <h2 class="text-lg sm:text-xl font-semibold mb-2">Deskripsi Produk:</h2>
            <p class="capitalize text-sm sm:text-base">Brand: Glatino</p>
            <p class="capitalize text-sm sm:text-base">Jenis: Tanpa Rem</p>            
            <p class="capitalize text-sm sm:text-base">Material: Rubber</p>
            <p class="capitalize text-sm sm:text-base">Dimensi: 3 Inch</p>            
          </div>
