      ...
      <div class="flex flex-col-reverse lg:grid lg:grid-cols-2 gap-10 items-start">
        ...
        <div>
          ...
          <p class="text-gray-700 text-base sm:text-lg mb-6 leading-relaxed">
            A 2-inch flat caster wheel made from red PP material, designed to support movement and smooth rolling.
          </p>
        ...
        <div class="flex justify-center items-center w-full">
          <img
            src="/asset/product/roller-caster/roda-gepeng-red-pp-2-dengan-rem.png"
            alt="Roda Gepeng Red PP 2"
            class="rounded-2xl shadow-lg w-full aspect-video object-contain bg-white cursor-zoom-in"
            @click="openZoom('/asset/product/roller-caster/roda-gepeng-red-pp-2-dengan-rem.png')"
          />
        </div>
      </div>
