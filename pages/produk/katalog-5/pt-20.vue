    ...
    <div class="max-w-screen-xl mx-auto px-4 sm:px-6 py-10 mt-10 font-poppins text-white">
      ...
      <nav class="text-xs text-gray-400 mb-6" aria-label="Breadcrumb">
        <ol class="flex flex-wrap items-center gap-2">
          ...
          <li>/</li>
          <li class="text-white font-semibold">PT-20</li>
        </ol>
      </nav>
      ...
      <div class="grid lg:grid-cols-2 gap-10 items-start">
        ...
        <div>
          ...
          <div class="mb-6 space-y-1">
            ...
            <p class="capitalize text-sm sm:text-base">Tipe: PT-20 (Top)</p>
          </div>
        ...
        <div class="flex justify-center items-center w-full">
          <img
            src="@/assets/product/patch-fitting/pt-20/produk.png"
      ...
      <div class="mt-14 border-t border-gray-700 pt-20">
        ...
        <div class="flex flex-col items-center">
          <img
            src="@/assets/product/patch-fitting/pt-20/ukuran-putih.png"
