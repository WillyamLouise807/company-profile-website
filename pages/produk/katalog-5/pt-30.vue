    ...
    <div class="max-w-screen-2xl mx-auto px-4 sm:px-6 py-10 mt-10 font-poppins text-black">
      ...
      <nav class="text-xs text-gray-400 mb-6" aria-label="Breadcrumb">
        <ol class="flex flex-wrap items-center gap-2">
          ...
          <li>/</li>
          <li class="text-black font-semibold">PT-30 Top/Pivot</li>
        </ol>
      </nav>
      ...
      <div class="flex flex-col-reverse lg:grid lg:grid-cols-2 gap-10 items-start">
        <!-- Deskripsi -->
        <div>
          <h1 class="text-2xl sm:text-3xl md:text-4xl font-bold mb-4">Patch Fitting PT-30 Top/Pivot</h1>
        ...
        <div class="flex justify-center items-center w-full">
          <img
            src="/asset/product/patch-fitting/pt-30/produk.png"
            alt="Patch Fitting PT-30"
            class="rounded-2xl shadow-lg w-full aspect-video object-contain bg-white cursor-zoom-in"
            @click="openZoom('/asset/product/patch-fitting/pt-30/produk.png')"
          />
        </div>
      </div>

      <!-- Dimensi -->
      <div class="mt-14 border-t border-gray-700 pt-30">
        <h2 class="text-xl sm:text-2xl font-semibold mb-4 text-center md:text-left">Product Dimensions</h2>
        <div class="flex flex-col items-center">
          <img
            src="/asset/product/patch-fitting/pt-30/ukuran-hitam.png"
            alt="Ukuran Patch Fitting PT-30"
            class="rounded-xl shadow-md max-w-xl w-full bg-white p-4 cursor-zoom-in"
            @click="openZoom('/asset/product/patch-fitting/pt-30/ukuran-hitam.png')"
          />
