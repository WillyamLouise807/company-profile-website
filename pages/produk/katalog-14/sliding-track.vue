    ...
    <div class="max-w-screen-2xl mx-auto px-4 sm:px-6 py-10 mt-10 font-poppins text-black">
      ...
      <nav class="text-xs text-gray-400 mb-6" aria-label="Breadcrumb">
        <ol class="flex flex-wrap items-center gap-2">
          ...
          <li>/</li>
          <li class="text-black font-semibold">Sliding Track</li>
        </ol>
      </nav>
      ...
      <div class="flex flex-col-reverse lg:grid lg:grid-cols-2 gap-10 items-start">
        ...
        <div>
          ...
          <p class="text-gray-700 text-base sm:text-lg mb-6 leading-relaxed">
            A track used to guide sliding panels or doors, allowing smooth and stable movement.
          </p>
      ...
      <div class="mt-14 border-t border-gray-200 pt-10">
        ...
        <div class="flex flex-col md:flex-row items-center justify-center gap-6">
          <img
            src="/asset/product/roller/sliding-track/ukuran-1.png"
            alt="Ukuran 1"
            ...
            @click="openZoom('/asset/product/roller/sliding-track/ukuran-1.png')"
          />
          <img
            src="/asset/product/roller/sliding-track/ukuran-2.png"
            alt="Ukuran 2"
            class="rounded-xl shadow-md bg-white p-4 cursor-zoom-in object-contain 
                  w-full sm:w-3/4 md:w-1/2 
                  h-56 sm:h-60 md:h-64 lg:h-72 xl:h-80"
            @click="openZoom('/asset/product/roller/sliding-track/ukuran-2.png')"
          />
        </div>
...
const images = [
  '/asset/product/roller/sliding-track/produk-1.png',
  '/asset/product/roller/sliding-track/produk-2.png',
  '/asset/product/roller/sliding-track/produk-3.png',
  '/asset/product/roller/sliding-track/produk-4.png'
]
