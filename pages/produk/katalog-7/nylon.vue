    ...
    <div class="max-w-screen-2xl mx-auto px-4 sm:px-6 py-10 mt-10 font-poppins text-black">
      ...
      <nav class="text-xs text-gray-400 mb-6" aria-label="Breadcrumb">
        <ol class="flex flex-wrap items-center gap-2">
          ...
          <li>/</li>
          <li class="text-black font-semibold">Nylon</li>
        </ol>
      </nav>
      ...
      <div class="flex flex-col-reverse lg:grid lg:grid-cols-2 gap-10 items-start">
        ...
        <div>
          ...
          <p class="text-gray-700 text-base sm:text-lg mb-6 leading-relaxed">
            The Glatino Nylon Casement Hinge is made from high-quality nylon material.
          </p>
        ...
        <div class="flex flex-col gap-4 w-full">
          ...
          <div class="flex justify-center items-center w-full">
            <img
              :src="currentImage"
              :alt="`Engsel Nylon ${currentSizeLabel}`"
      ...
      <!-- <div class="mt-14 border-t border-gray-700 pt-10">
        ...
        <div class="flex flex-col items-center">
          <img
            ...
            alt="Ukuran Engsel Nylon"
            class="rounded-xl shadow-md max-w-xl w-full bg-white p-4 cursor-zoom-in"
            @click="openZoom('/asset/product/engsel-casement/nylon/ukuran-hitam.png')"
          />
...
/* ===== SIZE VARIANTS ===== */
const sizes = [
  { value: '8', label: '8"', image: '/asset/product/engsel-casement/nylon/8-inch.png' },
  { value: '10', label: '10"', image: '/asset/product/engsel-casement/nylon/10-inch.png' },
  { value: '12', label: '12"', image: '/asset/product/engsel-casement/nylon/12-inch.png' },
  { value: '14', label: '14"', image: '/asset/product/engsel-casement/nylon/14-inch.png' },
  { value: '16', label: '16"', image: '/asset/product/engsel-casement/nylon/16-inch.png' },
  { value: '18', label: '18"', image: '/asset/product/engsel-casement/nylon/18-inch.png' },
  { value: '20', label: '20"', image: '/asset/product/engsel-casement/nylon/20-inch.png' },
  { value: '24', label: '24"', image: '/asset/product/engsel-casement/nylon/24-inch.png' },
]
