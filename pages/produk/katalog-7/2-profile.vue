    ...
    <div class="max-w-screen-2xl mx-auto px-4 sm:px-6 py-10 mt-10 font-poppins text-black">
      ...
      <nav class="text-xs text-gray-400 mb-6" aria-label="Breadcrumb">
        <ol class="flex flex-wrap items-center gap-2">
          ...
          <li>/</li>
          <li>
            <RouterLink to="/produk/engsel-casement" class="hover:underline text-black font-medium">Engsel Casement</RouterLink>
          </li>
          <li>/</li>
          <li class="text-black font-semibold">2 Profile</li>
        </ol>
      </nav>
      ...
      <div class="flex flex-col-reverse lg:grid lg:grid-cols-2 gap-10 items-start">
        ...
        <div>
          ...
          <p class="text-gray-700 text-base sm:text-lg mb-6 leading-relaxed">
            The Glatino 2-Profile Casement Hinge is made from high-quality iron material.
          </p>
          ...
          <div class="mb-6 space-y-1">
            ...
            <p class="capitalize text-sm sm:text-base">Size: {{ currentSizeLabel }}</p>              
          </div>
        ...
        <!-- Gambar Produk dengan Size Selector -->
        <div class="flex flex-col gap-4 w-full">
          <!-- Main Image -->
          <div class="flex justify-center items-center w-full">
            <img
              :src="currentImage"
              :alt="`Engsel 2 Profile ${currentSizeLabel}`"
          ...
          <div class="flex flex-wrap gap-2 justify-center">
            <button
              ...
              :class="[
                'cursor-pointer rounded-lg border-2 transition-all duration-200 px-4 py-2 font-semibold text-sm sm:text-base',
      ...
      <!-- <div class="mt-14 border-t border-gray-700 pt-10">
        ...
        <div class="flex flex-col items-center">
          <img
            src="/asset/product/engsel-casement/2-profile/ukuran-hitam.png"
            alt="Ukuran Engsel 2 Profile"
            class="rounded-xl shadow-md max-w-xl w-full bg-white p-4 cursor-zoom-in"
            @click="openZoom('/asset/product/engsel-casement/2-profile/ukuran-hitam.png')"
          />
      ...
      <div class="border-t border-gray-200 my-20 py-8">
        ...
        <div class="flex justify-center">
          <div class="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-2 xl:grid-cols-2 gap-4">
            <NuxtLink
              v-for="item in katalogLinks"
              :key="item.slug"
              :to="`/produk/katalog-7/${item.slug}`"
...
/* ===== SIZE VARIANTS ===== */
const sizes = [
  { value: '8', label: '8"', image: '/asset/product/engsel-casement/2-profile/8-inch.png' },
  { value: '10', label: '10"', image: '/asset/product/engsel-casement/2-profile/10-inch.png' },
  { value: '12', label: '12"', image: '/asset/product/engsel-casement/2-profile/12-inch.png' },
  { value: '14', label: '14"', image: '/asset/product/engsel-casement/2-profile/14-inch.png' },
  { value: '16', label: '16"', image: '/asset/product/engsel-casement/2-profile/16-inch.png' },
  // { value: '18', label: '18"', image: '/asset/product/engsel-casement/2-profile/18-inch.png' },
  { value: '20', label: '20"', image: '/asset/product/engsel-casement/2-profile/20-inch.png' },
  // { value: '24', label: '24"', image: '/asset/product/engsel-casement/2-profile/24-inch.png' },
]
...
const currentImage = computed(() => {
  ...
  return size ? size.image : sizes[0]!.image
})

const currentSizeLabel = computed(() => {
  const size = sizes.find(s => s.value === selectedSize.value)
  return size ? size.label : sizes[0]!.label
})
