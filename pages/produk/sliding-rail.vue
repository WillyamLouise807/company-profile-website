    ...
    <section class="relative w-full h-screen overflow-hidden font-poppins">
      ...
      <div class="container mx-auto h-full px-4 relative z-10 flex flex-col">
        ...
        <div class="text-red-700 text-sm opacity-90 pt-20 sm:pt-28 md:pt-36">
          <NuxtLink to="/product" class="hover:underline text-red-600 font-medium">Product</NuxtLink> / <span class="text-gray-600">Sliding Rail</span>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          >
            ...
            <div class="p-6 text-gray-800">
              ...
              <NuxtLink 
                :to="`/produk/katalog-13/${product.slug}`"
...
import bgImage from '/asset/product/sliding-rail/sliding-rail-banner.png';
