    ...
    <div class="max-w-screen-2xl mx-auto px-4 sm:px-6 py-10 mt-10 font-poppins text-black">
      ...
      <nav class="text-xs text-gray-400 mb-6" aria-label="Breadcrumb">
        <ol class="flex flex-wrap items-center gap-2">
          ...
          <li>/</li>
          <li class="text-black font-semibold">Sliding Lock Kait Besar</li>
        </ol>
      </nav>
      ...
      <div class="flex flex-col-reverse lg:grid lg:grid-cols-2 gap-10 items-start">
        <!-- Deskripsi -->
        <div>
          <h1 class="text-2xl sm:text-3xl md:text-4xl font-bold mb-4">Sliding Lock Kait Besar 41066</h1>
          ...
          <div class="mb-6 space-y-1">
            ...
            <p class="text-sm sm:text-base">Color: Chrome Gold</p>
        ...
        <div class="space-y-6 flex flex-col items-center w-full">
          ...
          <div class="grid grid-cols-5 gap-4 w-full">
            <img
              ...
              class="rounded-xl cursor-pointer border-2 h-20 w-full object-contain bg-white p-2"
              :class="{
...
import gambar5 from '/asset/product/alumunium-lock/41066/gambar-5.png'
