      ...
      <div class="flex flex-col-reverse lg:grid lg:grid-cols-2 gap-10 items-start">
        ...
        <div>
          ...
          <p class="text-gray-700 text-base sm:text-lg mb-6 leading-relaxed">
            Glatino Swing Door Stopper is made of aluminum zinc with a strong and durable powder-coated finish.
          </p>
...
const colors = [
  ...
  { name: 'cokelat', label: 'AC', hex: '#8A8A84', image: cokelat },
  { name: 'putih', label: 'White', hex: '#eeeeee', image: putih },
  { name: 'sn-ss', label: 'NB', hex: '#BDB080', image: snss }
]
