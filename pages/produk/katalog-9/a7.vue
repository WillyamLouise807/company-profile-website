      ...
      <div class="flex flex-col-reverse lg:grid lg:grid-cols-2 gap-10 items-start">
        ...
        <div>
          ...
          <p class="text-gray-700 text-base sm:text-lg mb-6 leading-relaxed">
            The A7 Lock is a high-quality aluminum lock designed for security and aesthetics. Available in five elegant colors and sturdy materials.          </p>
...
const colors = [
  { name: 'beige', label: 'Beige', hex: '#171D2B', image: beige, ukuran: ukuranPutih },
  { name: 'cokelat', label: 'Brown', hex: '#BDB080', image: cokelat, ukuran: ukuranPutih },
  { name: 'hitam', label: 'Black', hex: '#1f1f1f', image: hitam, ukuran: ukuranHitam },
  { name: 'putih', label: 'White', hex: '#ffffff', image: putih, ukuran: ukuranPutih },
  { name: 'ss', label: 'Silver', hex: '#E0E0E0', image: ss, ukuran: ukuranPutih }
]
