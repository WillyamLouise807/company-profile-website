    ...
    <div class="max-w-screen-2xl mx-auto px-4 sm:px-6 py-10 mt-10 font-poppins text-black">
      ...
      <nav class="text-xs text-gray-400 mb-6" aria-label="Breadcrumb">
        <ol class="flex flex-wrap items-center gap-2">
          ...
          <li>/</li>
          <li class="text-black font-semibold">Butt Hinge H</li>
        </ol>
      </nav>
        ...
        <div>
          ...
          <div class="mb-8">
            ...
            <div class="flex flex-wrap justify-center sm:justify-start items-center gap-6">
              ...
              <a href="https://shopee.co.id/Glatino-Engsel-Stainlees-Sus-H-304-Material-Stainless-Hinge-Steel-i.1442585495.28625500839?sp_atk=32c410ef-bc32-4034-93b7-c0d4066b149d&xptdk=32c410ef-bc32-4034-93b7-c0d4066b149d" target="_blank" rel="noopener noreferrer" class="hover:scale-105 transition-transform">
