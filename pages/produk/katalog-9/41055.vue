    ...
    <div class="max-w-screen-2xl mx-auto px-4 sm:px-6 py-10 mt-10 font-poppins text-black">
      ...
      <nav class="text-xs text-gray-400 mb-6" aria-label="Breadcrumb">
        <ol class="flex flex-wrap items-center gap-2">
          ...
          <li>/</li>
          <li class="text-black font-semibold">41055</li>
        </ol>
      </nav>
      ...
      <div class="flex flex-col-reverse lg:grid lg:grid-cols-2 gap-10 items-start">
        <!-- Deskripsi -->
        <div>
          <h1 class="text-2xl sm:text-3xl md:text-4xl font-bold mb-4">Handle 41055</h1>
          <p class="text-gray-700 text-base sm:text-lg mb-6 leading-relaxed">
            Handle 41055 adalah handle aluminium elegan dengan desain modern dan kokoh. Cocok untuk berbagai kebutuhan pintu dan jendela aluminium.
          </p>

          <div class="mb-6 space-y-1">
            <h2 class="text-lg sm:text-xl font-semibold mb-2">Deskripsi Produk:</h2>
            <p class="text-sm sm:text-base">Model: 41055</p>
          ...
          <div class="mb-8">
            ...
            <div class="flex flex-wrap justify-center sm:justify-start items-center gap-6">
              <a href="https://www.tokopedia.com/glatino-official-store/glatino-set-kunci-pintu-aluminium-premium-sliding-door-swing-door-aluminium-anti-karat-1730966994543412974?extParam=src%3Dshop%26whid%3D18402450&aff_unique_id=&channel=others&chain_key=" target="_blank" class="hover:scale-105 transition-transform">
...
// Galeri Gambar
import gambar1 from '@/assets/product/alumunium-lock/41055/gambar-1.png'
import gambar2 from '@/assets/product/alumunium-lock/41055/gambar-2.png'
import gambar3 from '@/assets/product/alumunium-lock/41055/gambar-3.png'
import gambar4 from '@/assets/product/alumunium-lock/41055/gambar-4.png'

// Gambar ukuran
import ukuranHitam from '@/assets/product/alumunium-lock/41055/ukuran-hitam.png'
// import ukuranPutih from '@/assets/product/alumunium-lock/41055/ukuran-putih.png' // Jika diperlukan
