...
const imageTerbuka = new URL('@/assets/product/alumunium-lock/engsel-piano/terbuka.png', import.meta.url).href
const imageTertutup = new URL('@/assets/product/alumunium-lock/engsel-piano/tertutup.png', import.meta.url).href
const ukuranImage = new URL('@/assets/product/alumunium-lock/engsel-piano/ukuran-hitam.png', import.meta.url).href
