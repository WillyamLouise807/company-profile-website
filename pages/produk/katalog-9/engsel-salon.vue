...
const images: Record<ColorName, string> = {
  hitam: new URL('@/assets/product/alumunium-lock/engsel-salon/hitam.png', import.meta.url).href,
  putih: new URL('@/assets/product/alumunium-lock/engsel-salon/putih.png', import.meta.url).href,
  cokelat: new URL('@/assets/product/alumunium-lock/engsel-salon/ss.png', import.meta.url).href,
  beige: new URL('@/assets/product/alumunium-lock/engsel-salon/beige.png', import.meta.url).href,
}

const ukuranImage = new URL('@/assets/product/alumunium-lock/engsel-salon/ukuran-hitam.png', import.meta.url).href
