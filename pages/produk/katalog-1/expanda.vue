    ...
    <div class="max-w-screen-2xl mx-auto px-4 sm:px-6 py-10 mt-10 font-poppins">
      ...
      <nav class="text-xs text-gray-500 mb-6" aria-label="Breadcrumb">
        <ol class="flex flex-wrap items-center gap-2">
          ...
          <li>/</li>
          <li>
            <RouterLink to="/produk/lever-handle-plate" class="hover:underline font-medium text-black">Lever Handle Plate</RouterLink>
          </li>
          <li>/</li>
      ...
      <div class="flex flex-col-reverse md:grid md:grid-cols-2 gap-10 items-start">
        ...
        <div>
          ...
          <p class="text-gray-700 text-base sm:text-lg mb-6 leading-relaxed">
            Glatino's Expanda door lock is specifically designed for screen doors. This product is ideal for maintaining smooth air circulation without compromising security.
          </p>
...
/* ===== DIMENSI ===== */
const dimensiImages = [
  '/asset/product/door-lock/expanda/ukuran-1.png',
  '/asset/product/door-lock/expanda/ukuran-2.png',
  '/asset/product/door-lock/expanda/ukuran-3.png'
]
