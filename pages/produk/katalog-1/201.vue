    ...
    <div class="max-w-screen-xl mx-auto px-4 sm:px-6 py-10 mt-10 font-poppins text-white">
      ...
      <nav class="text-xs text-gray-400 mb-6" aria-label="Breadcrumb">
        <ol class="flex flex-wrap items-center gap-2">
          ...
          <li>/</li>
          <li class="text-white font-semibold">201</li>
        </ol>
      </nav>
      ...
      <div class="flex flex-col-reverse md:grid md:grid-cols-2 gap-10 items-start">
        ...
        <div>
          ...
          <p class="text-gray-400 text-base sm:text-lg mb-6 leading-relaxed">
            ...
            material stainless steel yang kokoh, paket ini sudah dilengkapi 3 anak kunci dan 
            body kunci presisi untuk memberikan rasa aman yang lebih tenang. Cocok digunakan 
            di berbagai jenis ruangan seperti kamar tidur, kamar mandi, atau ruang kerja.
          </p>
...
import hitam from '@/assets/product/door-lock/201/hitam.png'
import cokelat from '@/assets/product/door-lock/201/cokelat.png'
import putih from '@/assets/product/door-lock/201/putih.png'
import snss from '@/assets/product/door-lock/201/sn-ss.png'
import ukuran from '@/assets/product/door-lock/201/ukuran-putih.png'
