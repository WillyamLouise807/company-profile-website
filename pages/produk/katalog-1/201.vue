    ...
    <div class="max-w-screen-2xl mx-auto px-4 sm:px-6 py-10 mt-10 font-poppins text-black">
      ...
      <div class="flex flex-col-reverse lg:grid lg:grid-cols-2 gap-10 items-start">
        ...
        <div>
          ...
          <p class="text-gray-700 text-base sm:text-lg mb-6 leading-relaxed">
            With a simple design and elegant color choices, the Glatino Model C door handle is the perfect choice to complement the look of your home's doors. Made of sturdy stainless steel, this package includes three keys and a precision lock body for added peace of mind. It's suitable for use in various rooms, including bedrooms, bathrooms, and offices.           
          </p>

          <div class="mb-6 space-y-1">
            <h2 class="text-lg sm:text-xl font-semibold mb-2">Product Description:</h2>          
            <p class="capitalize text-sm sm:text-base">HR 201 1 Set:</p>
      ...
      >
        <div class="bg-white p-4 md:p-6 rounded-xl shadow-2xl max-w-4xl w-full">
          <img
            :src="ukuranImage"
            alt="Zoomed Ukuran Door Lock 201"
...
import hitam from '/asset/product/door-lock/201/hitam.png'
import cokelat from '/asset/product/door-lock/201/cokelat.png'
import putih from '/asset/product/door-lock/201/putih.png'
import snss from '/asset/product/door-lock/201/sn-ss.png'
import ukuran from '/asset/product/door-lock/201/ukuran-hitam.png'
