      ...
      <div class="flex flex-col-reverse md:grid md:grid-cols-2 gap-10 items-start">
        ...
        <div>
          <h1 class="text-2xl sm:text-3xl md:text-4xl font-bold mb-4">
            Bathroom Door Lock 902
          </h1>

          <p class="text-gray-700 text-base sm:text-lg mb-6 leading-relaxed">
            The Glatino bathroom door lock is made of rust-resistant stainless steel,
            making it an ideal choice for damp areas like bathrooms.
          </p>
          ...
          <div class="mb-8">
            ...
            <div class="flex flex-wrap justify-center md:justify-start items-center gap-6">
              ...
              <a
                href="https://shopee.co.id/Glatino-Bathroom-Buddy-902-Kunci-Kamar-mandi"
                target="_blank"
                rel="noopener noreferrer"
                class="hover:scale-105 transition-transform"
              >
...
// DIMENSI BARU (2 GAMBAR)
import ukuran1 from '/asset/product/door-lock/902/ukuran-1.png'
import ukuran2 from '/asset/product/door-lock/902/ukuran-2.png'
...
const selectedColorLabel = computed(() =>
  colors.find(c => c.name === selectedColor.value)?.label || ''
)
...
/* ===== ACCESSORIES ===== */
const accessories = [
  '/asset/product/door-lock/902/aksesoris-1.png',
  '/asset/product/door-lock/902/aksesoris-2.png',  
]
