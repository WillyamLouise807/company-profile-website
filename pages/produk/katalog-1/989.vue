<template>
  <div class="bg-white">
    <div class="max-w-screen-2xl mx-auto px-4 sm:px-6 py-10 mt-10 font-poppins text-gray-900">
      <!-- Breadcrumb -->
        ...
        <div class="space-y-6 flex flex-col items-center">
          <transition name="fade" mode="out-in">
            <img
              ...
              class="rounded-2xl shadow-md w-full aspect-video object-contain cursor-zoom-in"
      ...
      <div class="mt-14 border-t border-gray-200 pt-10">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-3 gap-6 place-items-center">
          ...
          >
            <img
              :src="item"
              alt="Ukuran Lever Handle Plate 989"
      ...
      >
        ...
        <button
          @click="closeZoom"
          class="absolute top-4 right-4 z-10 bg-white rounded-full p-2 hover:bg-gray-200 transition"
        >
...
import hitam from '/asset/product/door-lock/989/hitam.png'
import cokelat from '/asset/product/door-lock/989/cokelat.png'
import putih from '/asset/product/door-lock/989/putih.png'
import snss from '/asset/product/door-lock/989/sn-ss.png'
...
/* ===== DIMENSI ===== */
const dimensiImages = [
  '/asset/product/door-lock/989/ukuran-1.png',
  '/asset/product/door-lock/989/ukuran-2.png',
  '/asset/product/door-lock/989/ukuran-3.png'
]
