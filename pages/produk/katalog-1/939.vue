        ...
        <div>
          ...
          <div class="mb-8">
            ...
            <div class="flex flex-wrap justify-center md:justify-start items-center gap-6">
              <a href="https://www.tokopedia.com/glatino-official-store/glatino-glt-939-lockset-type-bahan-aluminium-kunci-pintu-set-handle-lengkap-1731487333655152366?extParam=src%3Dshop%26whid%3D18402450&aff_unique_id=&channel=others&chain_key=" target="_blank" rel="noopener noreferrer" class="hover:scale-105 transition-transform">
                <img src="@/assets/product/tokopedia 1.png" alt="Tokopedia" class="w-14 sm:w-16" />
              </a>
              <a href="https://shopee.co.id/Glatino-GLT-939-LockSet-Type-Bahan-Aluminium-Kunci-Pintu-Set-Handle-Lengkap-i.1442585495.27222737426?sp_atk=dd827fd3-6e37-4abb-b37d-dab9dcaef53f&xptdk=dd827fd3-6e37-4abb-b37d-dab9dcaef53f" target="_blank" rel="noopener noreferrer" class="hover:scale-105 transition-transform">
