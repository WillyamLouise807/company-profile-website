      ...
      <div class="flex flex-col-reverse lg:grid lg:grid-cols-2 gap-10 items-start">
        ...
        <div>
          ...
          <div class="mb-6 space-y-1">
            ...
            <p class="capitalize text-sm sm:text-base">LHP 939 1 Set:</p>
...
/* ===== ACCESSORIES ===== */
const accessories = [
  '/asset/product/door-lock/939/aksesoris-1.png',
  '/asset/product/door-lock/939/aksesoris-2.png',
  '/asset/product/door-lock/939/aksesoris-3.png',
]
