    ...
    <div class="max-w-screen-xl mx-auto px-4 sm:px-6 py-10 mt-10 font-poppins text-white">
      ...
      <nav class="text-xs text-gray-400 mb-6" aria-label="Breadcrumb">
        <ol class="flex flex-wrap items-center gap-2">
          ...
          <li>/</li>
          <li class="text-white font-semibold">820</li>
        </ol>
      </nav>
...
import hitam from '@/assets/product/door-lock/820/hitam.png'
import cokelat from '@/assets/product/door-lock/820/cokelat.png'
import putih from '@/assets/product/door-lock/820/putih.png'
import snss from '@/assets/product/door-lock/820/sn-ss.png'
import ukuran from '@/assets/product/door-lock/820/ukuran-putih.png'
