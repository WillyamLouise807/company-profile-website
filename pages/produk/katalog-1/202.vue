      ...
      <div class="flex flex-col-reverse md:grid md:grid-cols-2 gap-10 items-start">
        ...
        <div>
          ...
          <p class="text-gray-700 text-base sm:text-lg mb-6 leading-relaxed">
            Elegant design & complete with SUS 304 Stainless material. Attractive color, strong, and suitable for various types of doors in your home.
          </p>

          <div class="mb-6 space-y-1">
            <h2 class="text-lg sm:text-xl font-semibold mb-2">Product Description:</h2>
            
            <p class="capitalize text-sm sm:text-base">HR 202 1 Set:</p>
...
import hitam from '/asset/product/door-lock/202/hitam.png'
import cokelat from '/asset/product/door-lock/202/cokelat.png'
import putih from '/asset/product/door-lock/202/putih.png'
import snss from '/asset/product/door-lock/202/sn-ss.png'
import ukuran from '/asset/product/door-lock/202/ukuran-hitam.png'
...
/* ===== DIMENSI ===== */
const dimensiImages = [
  '/asset/product/door-lock/202/ukuran-1.png',
  '/asset/product/door-lock/202/ukuran-2.png',
  '/asset/product/door-lock/202/ukuran-3.png'
]
