  ...
  <div class="font-poppins">
    ...
    <section class="relative w-full h-screen overflow-hidden font-poppins">
      ...
      <div class="container mx-auto h-full px-4 relative z-10 flex flex-col">
        ...
        <div class="text-red-700 text-sm opacity-90 pt-20 sm:pt-28 md:pt-36">
          <NuxtLink to="/product" class="hover:underline text-red-600 font-medium">Product</NuxtLink> / <span class="text-gray-600">Window Lock</span>
        </div>

        <!-- Hero Text Centered -->
        <div class="flex-grow flex items-center justify-center">
          <div class="text-center max-w-2xl mx-auto text-red-800 transform -translate-y-6">
            <h1 class="text-3xl sm:text-4xl font-bold leading-relaxed mb-4">Window Lock Series</h1>
            <p class="text-base sm:text-lg text-gray-700">Sistem pengunci jendela dengan desain kokoh dan mekanisme presisi, memberikan keamanan ekstra dan performa andal untuk berbagai tipe jendela.</p>
          </div>
        </div>
      </div>
    </section>
    ...
    <section class="py-16 px-4 sm:px-6 lg:px-12 bg-white">
      <div class="container mx-auto">
        <h2 class="text-2xl sm:text-3xl font-bold mb-8 text-center text-red-700">Produk Window Lock</h2>

        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          <div 
            v-for="(product, index) in floorHingeProduts"
            :key="index"
          ...
          >
            ...
            <div class="p-6 text-gray-800">
              ...
              <NuxtLink 
                :to="`/produk/katalog-8/${product.slug}`"
