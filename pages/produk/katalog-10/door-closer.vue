      ...
      <div class="flex flex-col-reverse lg:grid lg:grid-cols-2 gap-10 items-start">
        ...
        <div>
          ...
          <p class="text-gray-700 text-base sm:text-lg mb-6 leading-relaxed">
            The Glatino Door Closer is designed with automatic closing mechanism. Suitable for various types of doors.
          </p>
      ...
      <div class="mt-14 border-t border-gray-200 pt-10">
        ...
        <div class="flex justify-center">
          <img
            ...
            @click="openZoom('/asset/product/door-closer/ukuran.png')"
          />
        </div>
...
const selectedImage = ref<string>(colors[0]!.image)
