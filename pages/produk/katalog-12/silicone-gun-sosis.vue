    ...
    <div class="max-w-screen-2xl mx-auto px-4 sm:px-6 py-10 mt-10 font-poppins text-black">
      ...
      <nav class="text-xs text-gray-400 mb-6" aria-label="Breadcrumb">
        <ol class="flex flex-wrap items-center gap-2">
          ...
          <li>/</li>
          <li class="text-black font-semibold">Silicone Gun Sosis</li>
        </ol>
      </nav>
      ...
      <div class="flex flex-col-reverse lg:grid lg:grid-cols-2 gap-10 items-start">
        ...
        <div>
          ...
          <p class="text-gray-700 text-base sm:text-lg mb-6 leading-relaxed">
            A hand tool designed to apply silicone sealant in sausage packaging easily and smoothly.
          </p>
        ...
        <div class="flex justify-center items-center w-full">
          <img
            src="/asset/product/accessories/silicone-gun-sosis/produk.png"
            alt="Accessories Silicone Gun Sosis"
            class="rounded-2xl shadow-lg w-full aspect-video object-contain bg-white cursor-zoom-in"
            @click="openZoom('/asset/product/accessories/silicone-gun-sosis/produk.png')"
          />
        </div>
      </div>
