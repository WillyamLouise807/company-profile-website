    ...
    <div class="max-w-screen-2xl mx-auto px-4 sm:px-6 py-10 mt-10 font-poppins text-black">
      ...
      <nav class="text-xs text-gray-400 mb-6" aria-label="Breadcrumb">
        <ol class="flex flex-wrap items-center gap-2">
          ...
          <li>/</li>
          <li class="text-black font-semibold">Swivel Rod Connector</li>
        </ol>
      </nav>
      ...
      <div class="flex flex-col-reverse lg:grid lg:grid-cols-2 gap-10 items-start">
        <!-- Deskripsi -->
        <div>
          <h1 class="text-2xl sm:text-3xl md:text-4xl font-bold mb-4">Swivel Rod Connector</h1>
          <p class="text-gray-700 text-base sm:text-lg mb-6 leading-relaxed">
            Swivel Rod Connector is designed to connect glass panels to rods or pipes with a swivel function, providing a secure and flexible solution for various applications. Made from high-quality materials, it ensures durability and a sleek appearance.
          </p>

          <div class="mb-6 space-y-1">
            <h2 class="text-lg sm:text-xl font-semibold mb-2">Product Description:</h2>
            <p class="capitalize text-sm sm:text-base">Material: SS304</p>
            <p class="capitalize text-sm sm:text-base">Color: PSS</p>            
          </div>
        ...
        <div class="flex justify-center items-center w-full">
          <img
            src="/asset/product/accessories/swivel-rod-connector/produk.png"
            alt="Accessories Swivel Rod Connector"
            class="rounded-2xl shadow-lg w-full aspect-video object-contain bg-white cursor-zoom-in"
            @click="openZoom('/asset/product/accessories/swivel-rod-connector/produk.png')"
          />
        </div>
      </div>
      ...
      <div class="mt-14 border-t border-gray-200 pt-10">
        ...
        <div class="flex flex-col md:flex-row items-center justify-center gap-6">
          <img
            src="/asset/product/accessories/swivel-rod-connector/ukuran.png"
            alt="Ukuran Swivel Rod Connector"
            ...
            @click="openZoom('/asset/product/accessories/swivel-rod-connector/ukuran.png')"
          />          
        </div>
