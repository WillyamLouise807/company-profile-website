      ...
      <div class="flex flex-col-reverse lg:grid lg:grid-cols-2 gap-10 items-start">
        ...
        <div>
          ...
          <p class="text-gray-700 text-base sm:text-lg mb-6 leading-relaxed">
            Road Glass Connector is designed to connect glass panels to rods or pipes, providing a secure and stylish solution for various applications.
          </p>
        ...
        <div class="flex justify-center items-center w-full">
          <img
            ...
            @click="openZoom('/asset/product/accessories/rod-glass-connector/produk.png')"
          />
        </div>
      </div>
