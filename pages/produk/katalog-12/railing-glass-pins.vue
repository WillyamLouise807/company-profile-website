    ...
    <div class="max-w-screen-2xl mx-auto px-4 sm:px-6 py-10 mt-10 font-poppins text-black">
      ...
      <nav class="text-xs text-gray-400 mb-6" aria-label="Breadcrumb">
        <ol class="flex flex-wrap items-center gap-2">
          ...
          <li>/</li>
          <li class="text-black font-semibold">Railing Glass Pins</li>
        </ol>
      </nav>
      ...
      <div class="flex flex-col-reverse lg:grid lg:grid-cols-2 gap-10 items-start">
        <!-- Deskripsi -->
        <div>
          <h1 class="text-2xl sm:text-3xl md:text-4xl font-bold mb-4">Railing Glass Pins</h1>
          <p class="text-gray-700 text-base sm:text-lg mb-6 leading-relaxed">
            Railing Glass Pins is designed to connect glass panels to rods or pipes, providing a secure and stylish solution for various applications.
          </p>
        ...
        <div class="flex justify-center items-center w-full">
          <img
            src="/asset/product/accessories/railing-glass-pins/produk.png"
            alt="Accessories Railing Glass Pins"
            class="rounded-2xl shadow-lg w-full aspect-video object-contain bg-white cursor-zoom-in"
            @click="openZoom('/asset/product/accessories/railing-glass-pins/produk.png')"
          />
        </div>
      </div>
