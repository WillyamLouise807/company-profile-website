    ...
    <div class="max-w-screen-2xl mx-auto px-4 sm:px-6 py-10 mt-10 font-poppins text-black">
      ...
      <nav class="text-xs text-gray-400 mb-6" aria-label="Breadcrumb">
        <ol class="flex flex-wrap items-center gap-2">
          ...
          <li>/</li>
          <li class="text-black font-semibold">Bracket Ikan</li>
        </ol>
      </nav>
      ...
      <div class="flex flex-col-reverse lg:grid lg:grid-cols-2 gap-10 items-start">
        <!-- Deskripsi -->
        <div>
          <h1 class="text-2xl sm:text-3xl md:text-4xl font-bold mb-4">Bracket Ikan</h1>
          <p class="text-gray-700 text-base sm:text-lg mb-6 leading-relaxed">
            A bracket used to support or hold components in place. Designed for basic mounting and stability.
          </p>
          ...
          <div class="mb-8">
            ...
            <div class="flex flex-wrap justify-center sm:justify-start items-center gap-6">
              ...
              <a href="https://shopee.co.id/Glatino-Bracket-Ikan-Untuk-Penyambung-Penghubung-Pintu-Expanda-Material-Aluminium-i.1442585495.29627364104?extraParams=%7B%22display_model_id%22%3A242720573333%2C%22model_selection_logic%22%3A2%7D&sp_atk=02a80956-afdd-4a5f-81a7-3cc0364cda7c&xptdk=02a80956-afdd-4a5f-81a7-3cc0364cda7c" target="_blank" rel="noopener noreferrer" class="hover:scale-105 transition-transform">
        ...
        <div class="flex justify-center items-center w-full">
          <img
            ...
            @click="openZoom('/asset/product/accessories/bracket-ikan/produk.png')"
          />
        </div>
      </div>
      ...
      <div class="mt-14 border-t border-gray-200 pt-10">
        ...
        <div class="flex flex-col md:flex-row items-center justify-center gap-6">
          <img
            ...
            @click="openZoom('/asset/product/accessories/bracket-ikan/ukuran-hitam.png')"
          />          
        </div>
