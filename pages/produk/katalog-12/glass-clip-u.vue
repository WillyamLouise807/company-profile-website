      ...
      <div class="flex flex-col-reverse lg:grid lg:grid-cols-2 gap-10 items-start">
        ...
        <div>
          ...
          <p class="text-gray-700 text-base sm:text-lg mb-6 leading-relaxed">
            The Glass Clip U connects glass panels to aluminum or metal frames, providing strength and a sleek appearance.
          </p>
          ...
          <div class="mb-8">
            ...
            <div class="flex flex-wrap justify-center sm:justify-start items-center gap-6">
              ...
              <a href="https://shopee.co.id/Glatino-Glass-Clip-12MM-Type-U-Baut-Clamp-Penjepit-Kaca-i.1442585495.29442894617?extraParams=%7B%22display_model_id%22%3A296954797981%2C%22model_selection_logic%22%3A2%7D" target="_blank" rel="noopener noreferrer" class="hover:scale-105 transition-transform">
