    ...
    <div class="max-w-screen-2xl mx-auto px-4 sm:px-6 py-10 mt-10 font-poppins text-black">
      ...
      <nav class="text-xs text-gray-400 mb-6" aria-label="Breadcrumb">
        <ol class="flex flex-wrap items-center gap-2">
          ...
          <li>/</li>
          <li class="text-black font-semibold">Silicone Gun</li>
        </ol>
      </nav>
      ...
      <div class="flex flex-col-reverse lg:grid lg:grid-cols-2 gap-10 items-start">
        <!-- Deskripsi -->
        <div>
          <h1 class="text-2xl sm:text-3xl md:text-4xl font-bold mb-4">Silicone Gun</h1>
          <p class="text-gray-700 text-base sm:text-lg mb-6 leading-relaxed">
            A hand tool used to apply silicone sealant easily and evenly.
          </p>

          <!-- <div class="mb-6 space-y-1">
            <h2 class="text-lg sm:text-xl font-semibold mb-2">Product Description:</h2>
            <p class="capitalize text-sm sm:text-base">Brand: Glatino</p>
            <p class="capitalize text-sm sm:text-base">Type: Push Door / Sliding Handle</p>
          ...
          <div class="mb-8">
            ...
            <div class="flex flex-wrap justify-center sm:justify-start items-center gap-6">
              ...
              <a href="https://shopee.co.id/Glatino-Alat-Tembakan-Lem-Sealant-Sillicone-Lem-Botol-i.1442585495.49451534468?extraParams=%7B%22display_model_id%22%3A375140279152%2C%22model_selection_logic%22%3A3%7D" target="_blank" rel="noopener noreferrer" class="hover:scale-105 transition-transform">
        ...
        <div class="flex justify-center items-center w-full">
          <img
            src="/asset/product/accessories/tembak-silicone/produk.png"
            alt="Accessories Tembak Silicone"
            class="rounded-2xl shadow-lg w-full aspect-video object-contain bg-white cursor-zoom-in"
            @click="openZoom('/asset/product/accessories/tembak-silicone/produk.png')"
          />
        </div>
      </div>
      ...
      <!-- <div class="mt-14 border-t border-gray-700 pt-10">
        ...
        <div class="flex flex-col items-center">
          <img
            src="/asset/product/accessories/tembak-silicone/ukuran-hitam.png"
            alt="Ukuran Accessories Tembak Silicone"
      ...
      >
        <div class="bg-white p-4 md:p-6 rounded-xl shadow-2xl max-w-4xl w-full">
          <img
            src="/asset/product/accessories/tembak-silicone/ukuran-hitam.png"
            alt="Zoomed Ukuran Accessories Tembak Silicone"
