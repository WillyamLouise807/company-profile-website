    ...
    <div class="max-w-screen-2xl mx-auto px-4 sm:px-6 py-10 mt-10 font-poppins text-black">
      ...
      <nav class="text-xs text-gray-400 mb-6" aria-label="Breadcrumb">
        <ol class="flex flex-wrap items-center gap-2">
          ...
          <li>/</li>
          <li class="text-black font-semibold">Corner Screen Single</li>
        </ol>
      </nav>
      ...
      <div class="flex flex-col-reverse lg:grid lg:grid-cols-2 gap-10 items-start">
        <!-- Deskripsi -->
        <div>
          <h1 class="text-2xl sm:text-3xl md:text-4xl font-bold mb-4">Corner Screen Single</h1>
          <p class="text-gray-700 text-base sm:text-lg mb-6 leading-relaxed">
            Corner Screen Single is designed to connect glass panels at a corner angle, providing a secure and stylish solution for various applications. Made from high-quality materials, it ensures durability and a sleek appearance.
          </p>

          <div class="mb-6 space-y-1">
            <h2 class="text-lg sm:text-xl font-semibold mb-2">Product Description:</h2>
            <p class="capitalize text-sm sm:text-base">Get:</p>
            <p class="capitalize text-sm sm:text-base">- Roda 078 (2pcs)</p>
            <p class="capitalize text-sm sm:text-base">- Kancing 078 (2pcs)</p>
            <p class="capitalize text-sm sm:text-base">- Bracket Hollow (2pcs)</p>
            <p class="capitalize text-sm sm:text-base">- Fitting Rol (2pcs)</p>
            <p class="capitalize text-sm sm:text-base">- Fitting Kit (2pcs)</p>
            <p class="capitalize text-sm sm:text-base">- Floor Guide (1pcs)</p>
            <p class="text-sm sm:text-base">- Handle Tanam 46mm (1pcs)</p>
          </div>
        ...
        <div class="flex justify-center items-center w-full">
          <img
            src="/asset/product/accessories/corner-screen-single/produk.png"
