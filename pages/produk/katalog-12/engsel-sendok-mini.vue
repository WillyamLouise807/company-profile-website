      ...
      <div class="flex flex-col-reverse lg:grid lg:grid-cols-2 gap-10 items-start">
        ...
        <div>
          ...
          <div class="mb-6 space-y-1">
            ...
            <p class="capitalize text-sm sm:text-base">Type: Clip on soft closing hinge</p>
            <p class="capitalize text-sm sm:text-base">Material: Cold Rolled Steel</p>
            <p class="capitalize text-sm sm:text-base">Finish: Nickel</p>
          </div>
          ...
          <div class="mb-8">
            ...
            <div class="flex flex-wrap justify-center sm:justify-start items-center gap-6">
              ...
              <a href="https://shopee.co.id/" target="_blank" class="hover:scale-105 transition-transform">
