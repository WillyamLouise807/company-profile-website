      ...
      <div class="flex flex-col-reverse lg:grid lg:grid-cols-2 gap-10 items-start">
        ...
        <div>
          ...
          <p class="text-gray-700 text-base sm:text-lg mb-6 leading-relaxed">
            Glatino Stainless Steel Recessed Pulls are specifically designed for sliding or sliding doors, drawers, and cabinets. With a simple yet elegant design, these pulls are the perfect complement to your home furnishings.
          </p>
