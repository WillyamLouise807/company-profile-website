    ...
    <div class="max-w-screen-2xl mx-auto px-4 sm:px-6 py-10 mt-10 font-poppins text-black">
      ...
      <nav class="text-xs text-gray-400 mb-6" aria-label="Breadcrumb">
        <ol class="flex flex-wrap items-center gap-2">
          ...
          <li>/</li>
          <li class="text-black font-semibold">Glass Suction</li>
        </ol>
      </nav>
      ...
      <div class="flex flex-col-reverse lg:grid lg:grid-cols-2 gap-10 items-start">
        <!-- Deskripsi -->
        <div>
          <h1 class="text-2xl sm:text-3xl md:text-4xl font-bold mb-4">Glass Suction</h1>
          <p class="text-gray-700 text-base sm:text-lg mb-6 leading-relaxed">
            Glatino Stainless Steel Recessed Pulls are specifically designed for sliding or sliding doors, tiles and ceramics.
          </p>

          <div class="mb-6 space-y-1">
            <h2 class="text-lg sm:text-xl font-semibold mb-2">Product Description:</h2>                        
            <p class="capitalize text-sm sm:text-base">Load Lifting Power:</p>
          ...
          <div class="mb-8">
            ...
            <div class="flex flex-wrap justify-center sm:justify-start items-center gap-6">
              ...
              <a href="https://shopee.co.id/Glatino-GSP-Glass-Suction-Plate-High-Quality-Kop-Kaca-i.1442585495.43977772435?extraParams=%7B%22display_model_id%22%3A310397502597%2C%22model_selection_logic%22%3A3%7D" target="_blank" rel="noopener noreferrer" class="hover:scale-105 transition-transform">
        ...
        <div class="flex justify-center items-center w-full">
          <img
            src="/asset/product/accessories/glass-suction/produk.png"
            alt="Accessories Glass To Wall"
            class="rounded-2xl shadow-lg w-full aspect-video object-contain bg-white cursor-zoom-in"
            @click="openZoom('/asset/product/accessories/glass-suction/produk.png')"
          />
        </div>
      </div>
      ...
      <div class="mt-14 border-t border-gray-700 pt-10">
        ...
        <div class="flex flex-col items-center">
          <img
            src="/asset/product/accessories/glass-suction/ukuran-hitam.png"
            alt="Ukuran Accessories Glass To Wall"
            class="rounded-xl shadow-md max-w-xl w-full bg-white p-4 cursor-zoom-in"
            @click="openZoom('/asset/product/accessories/glass-suction/ukuran-hitam.png')"
          />
