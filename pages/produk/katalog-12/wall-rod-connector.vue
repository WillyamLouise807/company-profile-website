    ...
    <div class="max-w-screen-2xl mx-auto px-4 sm:px-6 py-10 mt-10 font-poppins text-black">
      ...
      <nav class="text-xs text-gray-400 mb-6" aria-label="Breadcrumb">
        <ol class="flex flex-wrap items-center gap-2">
          ...
          <li>/</li>
          <li class="text-black font-semibold">Wall Rod Connector</li>
        </ol>
      </nav>
      ...
      <div class="flex flex-col-reverse lg:grid lg:grid-cols-2 gap-10 items-start">
        <!-- Deskripsi -->
        <div>
          <h1 class="text-2xl sm:text-3xl md:text-4xl font-bold mb-4">Wall Rod Connector</h1>
          <p class="text-gray-700 text-base sm:text-lg mb-6 leading-relaxed">
            A small connector used to join rods or similar parts. It allows movement and helps parts rotate smoothly during use.
          </p>
        ...
        <div class="flex justify-center items-center w-full">
          <img
            src="/asset/product/accessories/wall-rod-connector/produk.png"
            alt="Accessories Wall Rod Connector"
            class="rounded-2xl shadow-lg w-full aspect-video object-contain bg-white cursor-zoom-in"
            @click="openZoom('/asset/product/accessories/wall-rod-connector/produk.png')"
          />
        </div>
      </div>
      ...
      <div class="mt-14 border-t border-gray-200 pt-10">
        ...
        <div class="flex flex-col md:flex-row items-center justify-center gap-6">
          <img
            src="/asset/product/accessories/wall-rod-connector/ukuran.png"
            alt="Ukuran Wall Rod Connector"
            ...
            @click="openZoom('/asset/product/accessories/wall-rod-connector/ukuran.png')"
          />          
        </div>
