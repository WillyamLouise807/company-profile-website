      ...
      <div class="flex flex-col-reverse lg:grid lg:grid-cols-2 gap-10 items-start">
        ...
        <div>
          ...
          <p class="text-gray-700 text-base sm:text-lg mb-6 leading-relaxed">
            Wall Rod Connector is designed to connect rods or pipes to walls, providing a secure and stylish solution for various applications. Made from high-quality materials, it ensures durability and a sleek appearance.
          </p>
