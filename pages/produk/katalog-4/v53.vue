  ...
  <div class="bg-white">
    <div class="max-w-screen-2xl mx-auto px-4 sm:px-6 py-10 mt-10 font-poppins text-black">
      ...
      <div class="flex flex-col-reverse lg:grid lg:grid-cols-2 gap-10 items-start">
        ...
        <div>
          ...
          <p class="text-gray-700 text-base sm:text-lg mb-6 leading-relaxed">
            The Glatino FH-53 series floor hinges are the ideal solution for heavy doors that require stable and secure movement.
          </p>
          ...
          <div class="mb-6 space-y-1">
            ...
            <p class="capitalize text-sm sm:text-base">Cover Material: SS 201</p>
            <p class="capitalize text-sm sm:text-base">Open Angle: 90°</p>
      ...
      <div class="mt-14 border-t border-gray-700 pt-10">
        <h2 class="text-xl sm:text-2xl font-semibold mb-6">Product Dimensions</h2>
...
/* DIMENSI – PUBLIC PATH (JANGAN IMPORT) */
const ukuranImages = [
  { label: '', src: '/asset/product/floor-hinge/v53/ukuran-1.png' },
  { label: '', src: '/asset/product/floor-hinge/v53/ukuran-2.png' },
  { label: '', src: '/asset/product/floor-hinge/v53/ukuran-3.png' },
  { label: '', src: '/asset/product/floor-hinge/v53/ukuran-4.png' }
]
