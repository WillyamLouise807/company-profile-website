      ...
      <div class="flex flex-col-reverse md:grid md:grid-cols-2 gap-10 items-start">
        ...
        <div>
          ...
          <div class="mb-6 space-y-1">
            ...
            <p class="capitalize text-sm sm:text-base">Ukuran: BL Perol 20mm + CYL 65mms</p>
          </div>
...
import hitam from '@/assets/product/mortise-lock/808/hitam.png'
import ukuran from '@/assets/product/mortise-lock/808/ukuran-hitam.png'
