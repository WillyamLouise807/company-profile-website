    ...
    <section class="relative w-full h-screen overflow-hidden font-poppins">
      ...
      <div class="container mx-auto h-full px-4 relative z-10 flex flex-col">
        ...
        <div class="text-white text-sm opacity-80 pt-36">
          <NuxtLink to="/product" class="hover:underline">Product</NuxtLink> / <span>Cylinder</span>
        </div>

        <!-- Hero Text Centered -->
        <div class="flex-grow flex items-center justify-center">
          <div class="text-center max-w-2xl mx-auto text-white transform -translate-y-6 ">
            <h1 class="text-2xl sm:text-3xl font-semibold leading-relaxed mb-6">Cylinder Series</h1>
            <p class="text-lg">Solusi kunci silinder inovatif yang dirancang untuk daya tahan, keamanan, dan kemudahan instalasi.</p>
          </div>
        </div>
      </div>
    </section>
      ...
      <section class="py-16 px-4 sm:px-6 lg:px-12 bg-black">
        <div class="max-w-7xl mx-auto">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 ">
            <div 
              v-for="(product, index) in cylinderProducts"
              :key="index"
